...
buttonGeral.forEach((item)=>{
    item.addEventListener('click', (e)=>{
        ...
        if(currentButton.classList.contains('all')){
            showLista(listaALL);
        } if(currentButton.classList.contains('powerapps')){
            showLista(listaALL, "powerapps")
        }

        if(currentButton.classList.contains('powerbi')){
            showLista(listaALL, "powerbi")
        }

        if(currentButton.classList.contains('outros')){
            showLista(listaALL, "outros")
        }
